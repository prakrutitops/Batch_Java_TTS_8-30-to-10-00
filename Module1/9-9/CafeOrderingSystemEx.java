...
public class CafeOrderingSystemEx implements ActionListener
{
	JFrame frame;
	JCheckBox chk1,chk2,chk3;
	JButton order;
	
	public CafeOrderingSystemEx() 
	{
		// TODO Auto-generated constructor stub
		frame=new JFrame("Cafe Ordering System");
		
		chk1=new JCheckBox("Pizaa @ rs.120");
		chk1.setBounds(178, 25, 117, 23);
		
		chk2=new JCheckBox("Burger @ rs.50");
		chk2.setBounds(178, 65, 117, 23);
		
		chk3=new JCheckBox("Coffee @ rs.70");
		chk3.setBounds(178, 105, 117, 23);
